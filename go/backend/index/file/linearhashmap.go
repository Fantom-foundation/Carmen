...
func NewLinearHashMap[K comparable, V comparable](pageCapacity, numBuckets, size int, pagePool *pagepool.PagePool[*Page[K, V]], hasher common.Hasher[K], comparator common.Comparator[K]) *LinearHashMap[K, V] {
