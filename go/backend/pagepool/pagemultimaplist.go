...
func NewPageMultiMapList[K comparable, V comparable](bucket, pageItems int, pagePool *PagePool[K, V]) *PageMultiMapList[K, V] {
...
func InitPageMultiMapList[K comparable, V comparable](bucket, pageItems int, pagePool *PagePool[K, V], data []common.MapEntry[K, V]) (*PageMultiMapList[K, V], error) {
	delegate := NewPageList[K, V](bucket, pageItems, pagePool)
