...
func TestPageInsertFindValues(t *testing.T) {
	p := NewPage[common.Address, uint32](100, common.AddressComparator{})
...
func testPageSorted[K comparable, V comparable](t *testing.T, page *Page[K, V], comparator common.Comparator[K]) {
