...
func NewLinearHashMap[K comparable, V comparable](blockItems, numBuckets int, pagePool *PagePool[K, V], hasher common.Hasher[K], comparator common.Comparator[K]) *LinearHashMap[K, V] {
