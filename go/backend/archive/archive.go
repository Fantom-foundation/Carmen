...
// ErrWitnessProfNotSupported is returned when the archive does not support witness proofs.
const ErrWitnessProfNotSupported = common.ConstError("witness proof not supported")
