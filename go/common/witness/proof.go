...
type Proof interface {
	...
	GetAccountElements(root common.Hash, address common.Address) ([]immutable.Bytes, bool)
	...
	GetStorageElements(root common.Hash, address common.Address, key common.Key) ([]immutable.Bytes, common.Hash, bool)
