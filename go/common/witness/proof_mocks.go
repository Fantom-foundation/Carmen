...
func (m *MockProof) GetElements() []string {
	m.ctrl.T.Helper()
...
func (m *MockProof) GetStorageElements(root common.Hash, address common.Address, keys ...common.Key) ([]string, common.Hash, bool) {
	m.ctrl.T.Helper()
	varargs := []any{root, address}
	for _, a := range keys {
		varargs = append(varargs, a)
