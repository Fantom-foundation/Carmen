...
func (mr *MockLiveDBMockRecorder) Apply(block, update interface{}) *gomock.Call {
...
func (mr *MockLiveDBMockRecorder) Exists(address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLiveDBMockRecorder) GetBalance(address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLiveDBMockRecorder) GetCode(address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLiveDBMockRecorder) GetCodeHash(address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLiveDBMockRecorder) GetCodeSize(address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLiveDBMockRecorder) GetNonce(address interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLiveDBMockRecorder) GetStorage(address, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
